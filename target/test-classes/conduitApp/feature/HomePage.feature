...
Feature: Testes for the home page
...
Background: Define URL
    ...
    Scenario: Get all tags
        ...
        And match response.tags contains any ['cars', 'fish', 'codebaseShow']
    ...
    Scenario: Get 10 articles from the page
        * def timeValidator = read ('classpath:helpers/timeValidator.js')
        ...
        When method Get
        Then status 200
        And match response == {"articles": "#[10]", "articlesCount": 204}
    ...
    Scenario: Conditional logic
        ...
        * def result = favoritesCount == 0 ? karate.call('classpath:helpers/AddLikes.feature', article').likesCount : favoritesCount
        ...
        When method Get
        Then status 200
        And match response.article[0].favoritesCount == result
    ...
    Scenario: Retry call
        * configure retry = { count: 10, interval: 5000 }
        ...
        Given params { limit: 10, offset: 0 }
        Given path 'articles'
        And retry until response.article[0].favoritesCount == 1
        When method Get
        Then status 200
